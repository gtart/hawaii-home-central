      ...
      <nav className="hidden md:flex fixed left-0 top-0 bottom-0 w-56 pt-16 border-r border-cream/10 bg-basalt flex-col z-30">
        <div className="flex-1 py-4 space-y-1">
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-2.5 mx-2 mb-1 rounded-lg text-sm bg-sandstone/10 text-sandstone hover:bg-sandstone/15 transition-colors w-[calc(100%-1rem)]"
          >
