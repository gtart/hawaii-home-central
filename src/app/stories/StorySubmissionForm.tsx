  ...
  if (!open) {
    return (
      <div className="bg-basalt-50 rounded-card p-8 text-center">
        ...
        <Button variant="secondary" size="lg" onClick={() => setOpen(true)} data-ph-capture-click="story-share-open">
          Share Your Story
        </Button>
      </div>
    )
    ...
    <div className="bg-basalt-50 rounded-card p-6 md:p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-center gap-4">
          <Button type="submit" disabled={submitting || !summary.trim()} data-ph-capture-click="story-submit">
