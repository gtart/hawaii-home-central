      ...
      // Overlay route: allow iframe embedding from any origin (bookmarklet sidebar)
      {
        ...
        headers: [
          ...securityHeaders,
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://va.vercel-scripts.com https://us-assets.i.posthog.com",
              ...
              "font-src 'self'",
              "connect-src 'self' https://www.google-analytics.com https://*.analytics.google.com https://*.google-analytics.com https://vitals.vercel-insights.com https://va.vercel-scripts.com https://us.i.posthog.com",
              "frame-ancestors *",
              "base-uri 'self'",
              "form-action 'self'",
            ].join('; '),
